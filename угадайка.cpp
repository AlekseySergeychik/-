// угадайка.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	if (again == 'y')
	{
		minBorder1 = rand() % (100 - number) + number;
		++tries;
